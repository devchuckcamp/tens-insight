...
class IncrementalTrainer:
    ...
    Usage:
        ...
        if should_retrain:
            ...
            next_version = trainer.get_next_version('churn')
            # Train your model using next_version
    """
    ...
    def check_training_necessity(
        ...
        try:
            ...
            last_training = session.execute(text("""
            ...
            feedback_info = session.execute(text("""
            ...
            if last_training_date:
                ...
                """), {"last_training_date": last_training_date}).scalar() or 0
    ...
    def get_next_version(self, model_type: str) -> str:
        ...
        Versions follow semantic versioning (v1, v2, ..., v1.1, v1.2, etc.)
        
        Args:
            model_type: 'churn' or 'product_area'
            
        Returns:
            Next version string (e.g., 'v2', 'v1.1')
        """
        versions = self.registry.list_versions(model_type, limit=100)
        ...
        max_major = max(major_versions) if major_versions else 0
    ...
    def get_previous_version_id(self, model_type: str) -> Optional[int]:
        ...
        """
        versions = self.registry.list_versions(model_type, limit=2)
    ...
    def should_promote_to_production(
        ...
        comparison = self.registry.compare_versions(
            ...
            promotion_threshold=improvement_threshold
        )
    ...
    def promote_version_to_production(
        ...
        try:
            self.registry.deploy_version(
                ...
                notes="Auto-promoted by continuous training system"
            )
